...
public class CompetitionTests {
    ...
    public void testDijkstraConstructor() {
    	CompetitionDijkstra dijkstra = new CompetitionDijkstra("tinyEWD.txt", 75, 71, 88);
        assertEquals(1, dijkstra.timeRequiredforCompetition());
        System.out.println(dijkstra.timeRequiredforCompetition());
        dijkstra = new CompetitionDijkstra("1000EWD.txt", 75, 71, 88);
       // assertEquals(1, dijkstra.timeRequiredforCompetition());
        System.out.println(dijkstra.timeRequiredforCompetition());
...
//        assertEquals(1, dijkstra.timeRequiredforCompetition());
  ...
  //      assertEquals(1, dijkstra.timeRequiredforCompetition());
    ...
    public void testFWConstructor() {
    	CompetitionFloydWarshall FW = new CompetitionFloydWarshall("tinyEWD.txt", 75, 71, 88);
        assertEquals(1, FW.timeRequiredforCompetition());
        
        FW = new CompetitionFloydWarshall("1000EWD.txt", 75, 71, 88);
        assertEquals(1, FW.timeRequiredforCompetition());
